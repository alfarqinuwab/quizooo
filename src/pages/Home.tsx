...
const Home: React.FC = () => {
  ...
  // Show only first 5 unless showAllUnits is true
  ...
  return (
    <div className="w-[1920px] min-h-screen bg-background flex flex-col items-center mx-auto">
                  ...
                  <div className="relative">
                      ...
                      onKeyDown={(e) => {
                        if (e.key === 'Enter') {
                          ...
                          if (index < teams.length - 1) {
                            teamInputRefs.current[index + 1]?.focus();
                    ...
                    {teams.length > 2 && (
                      <button
                        ...
                        className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-24 bg-red-500 text-white p-2 rounded-full hover:bg-red-600 transition-colors"
                      >
      ...
      {/* Power-ups Section */}
      <div className="w-full max-w-[1600px] mx-auto px-12 mb-12">
        <div className="flex items-center justify-center gap-4 mb-2">
          <h2 className="main-section-title mb-0 mt-0">اختر وسائل مساعدة</h2>
          <div className="flex items-center justify-center w-8 h-8 rounded-full bg-[#F59E0B] text-white font-bold">
